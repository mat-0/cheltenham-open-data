...
Cheltenham Open Data has added a [places to stay guide for Cheltenham](/staying-in-cheltenham) to the site.

The page pairs a live availability map with a list of well-known hotels in the town, so you can compare areas, check prices and book directly with the provider — handy whether you're visiting for the racecourse, one of Cheltenham's festivals, or as a base for exploring the Cotswolds.

...
Cheltenham Open Data has added a [local list of Cheltenham's GPs and Pharmacies](/cheltenham-gp-pharmacies) and Department for Environment, Food & Rural Affairs (DEFRA)'s [Air Quality](/cheltenham-air-quality) to the site.

Both sources are checked frequently and any changes are shown on the site as they are published.

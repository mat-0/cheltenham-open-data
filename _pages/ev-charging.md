---
layout: ev-charging
title: "Cheltenham EV Charging Points"
seo: "Where to charge an electric car in Cheltenham — a live map and list of public EV charging points, connector types and speeds across town."
...
## Public EV Charging Points in Cheltenham

Cheltenham's public charging network has grown quickly, with points now spread across town-centre car parks, supermarkets, hotels, retail parks and on-street bays. Whether you're a resident without a driveway, a commuter topping up during the day, or visiting for the races or a festival, the map and tables below show where to plug in, what connectors each site offers, and how fast you can expect to charge.
...
- **Type 2** — the standard connector for slow and fast AC charging, used by nearly every EV for destination and on-street charging.
- **CCS (Combined Charging System)** — the most common rapid DC connector on newer cars, adding Type 2's AC pins to two DC pins for high-speed charging.
- **CHAdeMO** — an older rapid DC standard, still found on some models such as the earlier Nissan Leaf.
...
- **Slow (3–6 kW)** — best overnight or for a long stay; typical of on-street and some workplace points.
- **Fast (7–22 kW)** — the workhorse of car parks and supermarkets; a useful top-up over a couple of hours.

...
## Cheltenham Crime Figures For 2026

This page shows monthly street-level crime counts for Cheltenham's neighbourhoods during 2026, using data from the [Police.uk API](https://data.police.uk/docs/method/crime-street/). The figures are based on approximate, anonymised locations and are updated monthly.
